  ...
  <div
    ...
    <div v-show="state.open" id="options" class="select__options options">
      ...
      >
        ...
        <div v-if="!option.notDelete && possibilityToDelete" @click.stop="removeSection(option.id,option.value)" class="option-select__select delete">
...
export default {
  ...
  setup(props, {emit}) {
    ...
    const removeSection = (id,value) => {
      emit('removeSection',id,value)
      console.log('click',id)
    }

    return {
      state, selectOption, activeSelect,removeSection
    }
  }
}
</script>